...
//관리자
	ArrayList<Product> selectProductList(int page);//관리자에서 상품보기
	int selectProductListCount();//관리자에서 상품보기
	ArrayList<Product> selectAdvertisingList(int page);//관리자에서 상품보기
	int selectAdvertisingListCount();//관리자에서 상품보기
...
//기업 - 상품
	ArrayList<Product> enterprise_selectList(int page); //기업 -상품리스트보기
	int enterprise_selectListCount(); //기업 -상품리스트보기
	...
	//기업 - 광고
	ArrayList<Product> enterprise_selectAdList(int page); //기업 -광고 리스트 보기
	int enterprise_selectAdListCount(); //기업 -광고 리스트 보기
	int insertAd_payment(Advertising advertising);//기업에서 결제 승인대기하기
	int insertAdvertising(Advertising advertising);//기업에서 결제 승인대기하기
	
	
	
	 ArrayList<Payment> selectProductPayments(int page);
	 int selectProductPaymentsCount();
	 ArrayList<Payment> selectAdvertisingPayments(int page);
	 int selectAdvertisingPaymentsCount();
