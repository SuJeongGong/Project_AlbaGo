...
//	ArrayList<Individual> selectIndividualList(HashMap<String, Object> map); //개인회원정보 전체를 보여주는 테이블
//	int selectIndividualListCount(HashMap<String, Object> map); //개인회원정보 전체를 보여주는 테이블의 총갯수
