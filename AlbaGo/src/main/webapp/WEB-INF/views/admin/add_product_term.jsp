							...
							<div class="card card-pricing text-center px-3 mb-4">
								...
								<div class="bg-transparent card-header pt-4 border-0">
									<h1 class="h4 font-weight-normal text-primary text-center mb-0"
										...
										<input type="text" placeholder="ex)100,000" size="9"></input>원<span
											class="h6 text-muted ml-2"><input type="text"
											placeholder="ex) / +5개" size="6"></input></span>
									</h1>
								</div>
								<div class="card-body pt-0">
									<ul class="list-unstyled mb-4">
										<input type="text" cols=121 rows=5 class="form-control" style="border-radius: 0px" placeholder="게시글 정보를 알려주세요">
									</ul>
									<ul class="list-unstyled mb-4">
										<input type="text" cols=121 rows=5 class="form-control" style="border-radius: 0px"	placeholder="기간 설정을 해 주세요">
									</ul>
								
								<a class="btn btn-info edit" href="path/to/settings"
									aria-label="Settings"> <i class="fa fa-pencil-square-o"
									aria-hidden="true">추가</i>
								</a>
							</div>
						</div>
					</div>
