				...
				<div class="container-fluid">
					...
					<div class="container mb-5 mt-5"
						style="height: 200px; width: 700px;">
							<form action="<%=request.getContextPath()%>/admin/add_product_no_term/result" name="product">
					
						<div class="pricing card-deck flex-column flex-md-row mb-3">
							<div class="card card-pricing text-center px-3 mb-4">
								<span
									class="h6 w-60 mx-auto px-4 py-1 rounded-bottom bg-primary text-white shadow-sm"><input
									type="text" placeholder="ex)아이템" size="6" name="name"></input></span>
								<div class="bg-transparent card-header pt-4 border-0">
									<h1 class="h4 font-weight-normal text-primary text-center mb-0"
										data-pricing-value="15">
										<input type="text" placeholder="ex)100,000" size="9" name="price"></input>원
										<span
											class="h6 text-muted ml-2"><input type="text"
											placeholder="ex) / +5개" size="6" name="amount"></input></span>
									</h1>
								</div>
