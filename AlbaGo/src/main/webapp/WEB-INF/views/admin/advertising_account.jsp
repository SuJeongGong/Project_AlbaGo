	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<form action="<%=request.getContextPath() %>/admin/account/advertising/update" name="product" id  = "product" class="col-xl-12" >
						...
						<div class="row form-group ">
								...
								<div class="bg-transparent card-header pt-4 border-0">
									<h1 class="h4 font-weight-normal text-primary text-center mb-0 form-group "
										...
										&nbsp;&nbsp;기간	&nbsp;&nbsp;<input type="text"   class="col-sm-4 form-control " name="term" value="<%=term%>">&nbsp;</div>
									</h1>
								</div>
								<div class="card-body pt-0">
									<ul class="list-unstyled mb-4 h4 font-weight-normal text-primary text-center" >
										...
										<input type="hidden" class="col-sm-10 form-control "
											style="border-radius: 0px" name="amount" value="<%=amount%>" />
																	
										<input type="hidden" class="col-sm-10 form-control "
											style="border-radius: 0px" name="type" value="<%=type%>" />
