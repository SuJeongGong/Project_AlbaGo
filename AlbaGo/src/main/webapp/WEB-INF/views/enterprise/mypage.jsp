                ...
                <div class="card col-xl-6 shadow mb-4">
                  <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">공고글 관리
                      <a href="recruit_list" class="btn btn-primary btn-icon-split"><span class="text">자세히</span></a>
                    </h6>
                  </div>
                  <div class="card-body">
                    <div class="text-xs">
                ...
                <div class="card col-xl-6 shadow mb-4">
                  <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">지원한 인재 목록
                      <a href="volunteer_list" class="btn btn-primary btn-icon-split"><span class="text">자세히</span></a>
                    </h6>
                  </div>
                  <div class="card-body">
                    <div class="text-xs">
