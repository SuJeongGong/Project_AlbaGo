                ...
                <div class="col-lg-6">
				                    <div class="job_details_header">
					                        <div class="single_jobs white-bg d-flex justify-content-between">
							                            <div class="jobs_left d-flex align-items-center">
							                                <div class="jobs_conetent">
							                                    <a href="<%=request.getContextPath()%>/enterprise/payment/list">
							                                        <h4>상품 구매 기록</h4>
							                                    </a>
							                                </div>
							                            </div>
							                            <div class="jobs_right">
							                                <div class="apply_now">
							                                    <a class="boxed-btn3 w-10" href="<%=request.getContextPath()%>/enterprise/payment/list">자세히</a>
							                                </div>
							                            </div>
					                        </div>
				                    </div>
				                ...
				                <div class="col-lg-6">
						                    <div class="job_details_header">
						                        <div class="single_jobs white-bg d-flex justify-content-between">
						                            ...
						                            <div class="jobs_right">
						                                <div class="apply_now">
						                                    <a class="boxed-btn3 w-10" href="<%=request.getContextPath()%>/enterprise/advertising/list">자세히</a>
						                                </div>
						                            </div>
						                        </div>
						                    </div>
					                    	<div class="descript_wrap white-bg">
								                        <div class="single_wrap">
																		...
																		<table width="95%">
																			<tr>
																				<th>사용한 공고글 </th><th>시작하는 날짜</th><th>끝나는 날짜</th>
																			</tr>
																		<%
																		...
																		%>
																				<tr>
																					<td><%=title%></td><td><%=startDate%></td><td><%=endDate%></td>
																				</tr>									
																				<%
																														}
																													%>
                ...
                <div class="col-lg-6">
				                    <div class="job_details_header">
					                        <div class="single_jobs white-bg d-flex justify-content-between">
							                            ...
							                            <div class="jobs_right">
							                                <div class="apply_now">
							                                    <a class="boxed-btn3 w-10" href="<%=request.getContextPath()%>/enterprise/payment/history/resume">자세히</a>
							                                </div>
							                            </div>
					                        </div>
				                    </div>
				                    <div class="descript_wrap white-bg">
						                        <div class="single_wrap">
											                            ...
											                            <br>
																			<table width="95%">
																				<tr>
																					<th>사용한 인재글</th><th>연락처</th><th>사용날짜</th>
																				</tr>
													<%
													...
													%>
																					<tr>
																						<td><%=boardResumeTitle%></td><td><%=phone%></td><td><%=date%></td>
																					</tr>									
																					<%
																															}
																														%>							
				                ...
				                <div class="col-lg-6">
						                    <div class="job_details_header">
						                        <div class="single_jobs white-bg d-flex justify-content-between">
						                            ...
						                            <div class="jobs_right">
						                                <div class="apply_now">
						                                    <a class="boxed-btn3 w-10" href="<%=request.getContextPath()%>/enterprise/payment/history/up">자세히</a>
						                                </div>
						                            </div>
						                        </div>
						                    </div>
					                    	<div class="descript_wrap white-bg">
								                        <div class="single_wrap">
											                            <p>up버튼 사용기록 최근 5개 입니다.
											                            <br>더 많은 사용 기록을 보시려면 자세히 버튼을 눌러주세요</p><br><table width="95%">
																			<tr>
																				<th>사용한 공고글 </th><th>사용한 날짜</th>
																			</tr>  
																		<%
