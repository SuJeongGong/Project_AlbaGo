          ...
          <div class="p-5">
           ...
           <div class="card-body">
            <form class="form-signin" method="POST" onSubmit="logincall();return false">
             ...
             <a href="sign_up" id="btn-sign"  type="submit">회원가입</a>
          ...
          <div class="p-5">
           ...
           <div class="card-body">
            <form class="form-signin" method="POST" onSubmit="logincall();return false">
              ...
              <input type="password" id="upw" class="form-control" placeholder="Password" required><br>
            <a href="find_id" id="btn-Find_id"  type="submit">아이디 찾기</a> / 
              <a href="find_pw" id="btn-Find_pw" type="submit">비밀번호 찾기</a>/   <a href="join" id="btn-sign"  type="submit">회원가입</a>
              <button id="btn-Yes" class="btn btn-lg btn-primary btn-block" type="submit">로 그 인</button>
            </form>
