					...
					<div class="blog_left_sidebar">
						...
						<article class="blog_item">
							<div class="blog_details">
								<div class="row">
									<div class="col-lg-5">
										<i class="fa fa-clock-o "></i><%=date.split(":")[0]%>:<%=date.split(":")[1]%></div>
									<p class="col-lg-4"><%=id%></p>
									<p class="col-lg-2">조회수</p>
									<p class="col-lg-1"><%=views%></p>
								</div>
								<a class="d-inline-block"
									href="<%=request.getContextPath()%>/community/content?community_id=<%=c_id%>">
									<h2><%=title%></h2>
								</a>
						...
						<nav class="blog-pagination justify-content-center d-flex">
							...
							<ul class="pagination">
								...
								<li class="page-item"><a href="?page=<%=pageNum - 1%>"
							...
							<a class="boxed-btn3" href="<%=request.getContextPath() %>/community/write">글쓰기</a>
						</nav>
					</div>
				</div>
			</div>
