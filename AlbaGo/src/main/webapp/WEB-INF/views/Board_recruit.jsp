              ...
              <tr>
                <td>작성일 데이트 피커 같이 해주세요,, &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  ...
                  <button type="button" class="btn btn-light dropdown-toggle btn-sm" data-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">담당자명
                  ...
                  <input type="text" class="texTyp " title="검색어 입력" id="dev_SearchKeyword" name="dev_SearchKeyword"
                    value="" autocomplete="off" placeholder="검색해주세요"></input>
